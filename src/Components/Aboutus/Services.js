  ...
  return(
    <div className="services-div">
      ...
      <div className="service-content white" style={{backgroundColor:'blue'}}>
        ...
        <p>Investment is interesting and it is secure enough to sail you through the floods of unannounced expenses that life puts you in! And GrowthWay Investments is here to help you invest smartly and securely.</p>
