  ...
  return(
    ...
    <div className="services-div" data-aos="fade-left" data-aos-duration="3000">
      ...
      <div className="service-content bg-dark-gray white">
         ...
         <Link to='/services/#service'><button className="mt3 fw6 white pa3 f5 grow pointer" style={{borderRadius:'8px',border:'none',backgroundColor:'#0069FF'}}>Learn More</button></Link>
      </div>
      ...
      <div className="service-content white" style={{backgroundColor:'#0069FF'}}>
        ...
        <Link to='/services/#service'><button className="mt5 fw6 bg-white black pa3 f5 grow pointer" style={{borderRadius:'8px',border:'none'}}>Learn More</button></Link>
      </div>
    </div>
    </div>
  )
