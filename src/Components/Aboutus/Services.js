  ...
  return(
    <div className="services-div">
      ...
      <div className="service-content bg-dark-gray white">
         ...
         <Link to='/'><button className="mt5 fw6 white pa3 f5 grow pointer" style={{borderRadius:'8px',border:'none',backgroundColor:'blue'}}>Learn More</button></Link>
      </div>
      ...
      <div className="service-content white" style={{backgroundColor:'blue'}}>
        ...
        <Link to='/'><button className="mt5 fw6 bg-white black pa3 f5 grow pointer" style={{borderRadius:'8px',border:'none'}}>Learn More</button></Link>
      </div>
    </div>
  )
}
