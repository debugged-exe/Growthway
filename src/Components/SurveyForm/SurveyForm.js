...
class SurveyForm extends React.PureComponent {
  ...
  enable = (e) =>{
    ...
    console.log(this.state.others);
		return (
			<div className="white survey-div" style={{overflow:'hidden'}}>
					<div className="center bg-white" style={{height:'80vh',width:'70vw'}}>
					  <h1 class="black">Let's understand your Short term investing needs better, with this Survey: </h1>
